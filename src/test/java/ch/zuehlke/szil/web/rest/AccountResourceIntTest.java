package ch.zuehlke.szil.web.rest;

import ch.zuehlke.szil.config.Constants;
import ch.zuehlke.szil.JhipsterScenariooApp;
import ch.zuehlke.szil.domain.Authority;
import ch.zuehlke.szil.domain.User;
import ch.zuehlke.szil.repository.AuthorityRepository;
import ch.zuehlke.szil.repository.UserRepository;
import ch.zuehlke.szil.security.AuthoritiesConstants;
import ch.zuehlke.szil.service.MailService;
import ch.zuehlke.szil.service.dto.UserDTO;
import ch.zuehlke.szil.web.rest.errors.ExceptionTranslator;
import ch.zuehlke.szil.web.rest.vm.KeyAndPasswordVM;
import ch.zuehlke.szil.web.rest.vm.ManagedUserVM;
import ch.zuehlke.szil.service.UserService;
...
@SpringBootTest(classes = JhipsterScenariooApp.class)
