package ch.zuehlke.szil.repository;

import ch.zuehlke.szil.JhipsterScenariooApp;
import ch.zuehlke.szil.config.Constants;
import ch.zuehlke.szil.config.audit.AuditEventConverter;
import ch.zuehlke.szil.domain.PersistentAuditEvent;
...
import static ch.zuehlke.szil.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
