...
# Build Status
[![Build Status](https://travis-ci.org/sebastianzillessen/jHipsterScenarioo.svg?branch=master)](https://travis-ci.org/sebastianzillessen/jHipsterScenarioo)
...
To optimize the jhipsterScenarioo application for production, run:
